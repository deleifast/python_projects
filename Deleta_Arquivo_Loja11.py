...
for raiz, diretorios, arquivos in os.walk('D:/PDV'):
    for arquivo in arquivos:
        if arquivo.endswith('loja11s_pdv.rar'):
           os.remove(os.path.join(raiz, arquivo))

for raiz, diretorios, arquivos in os.walk('D:/PDV'):
    for arquivo in arquivos:
        if arquivo.endswith('loja11_pdv.rar'):
           os.remove(os.path.join(raiz, arquivo))
...
os.chdir('D:/PDV/PLUGIN')

for raiz, diretorios, arquivos in os.walk('D:/PDV/PLUGIN'):
    for arquivo in arquivos:
        if arquivo.endswith('loja11s_plugin.rar'):
           os.remove(os.path.join(raiz, arquivo))

for raiz, diretorios, arquivos in os.walk('D:/PDV/PLUGIN'):
    for arquivo in arquivos:
        if arquivo.endswith('loja11_plugin.rar'):
           os.remove(os.path.join(raiz, arquivo))
