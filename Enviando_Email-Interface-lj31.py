...
try:
    host_ip = socket.gethostbyname('www.stone.com.br')
...
msg['From'] = de
msg['To'] = ', '.join(para)
msg['Subject'] = 'Conexão Retag'

# Corpo da mensagem
msg.attach(MIMEText('Pdv com erro de conexão com o Retag(TELEVENDAS), no anexo tem o nome da máquina e o ip', 'html', 'utf-8'))

# Arquivos anexos.
adiciona_anexo(msg, 'retag.txt')
