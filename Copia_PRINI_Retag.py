...
dest_dir = "Q:\\PDV\TX"
for file in glob.glob(r'C:/PDV/PRINI/loja50/*.*'):
	print(file)
	shutil.copy(file, dest_dir)
...
dest_dir = "Q:\\PDV\TX"
for file in glob.glob(r'C:/PDV/PRINI/loja51/*.*'):
	print(file)
	shutil.copy(file, dest_dir)
...
dest_dir = "Q:\\PDV\TX"
for file in glob.glob(r'C:/PDV/PRINI/loja52/*.*'):
	print(file)
	shutil.copy(file, dest_dir)
...
dest_dir = "Q:\\PDV\TX"
for file in glob.glob(r'C:/PDV/PRINI/loja53/*.*'):
	print(file)
	shutil.copy(file, dest_dir)
...
input("Pressione ENTER para terminar, fazer a loja 23!!!!")
