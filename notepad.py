...
class PyNotePad:
    ...
    def __init__(self):
        self.root = Tk()
        self.root.wm_title("Configuracao PRINI")# Aqui é o digito
        ...
        MENUarquivo.add_command(label="Salvar PRINI", command=self.salvar)
        MENUarquivo.add_command(label="Abrir PRINI", command=self.abrir)
